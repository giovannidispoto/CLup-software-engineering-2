...
%(and in general for all the operations that requires authentication)
...
\begin{tabularx}{\linewidth}{| l | X |}
    ...
    \hline
     \textbf{Endpoint} & /stores/:store\_id \\
    ...
    \textbf{Success Response} & \parbox{0.7\textwidth}{ \begin{itemize}[label={}] 
                \item code: 200 OK
                 \item Content: \{ 
                   store1:{ id : [string], name : [string], address : [string], opening\_hours : [string], categories\_of\_grocery : [ ] [string] time\_slots: [ ] 
                   }
                 \}
               \end{itemize}}\\
    ...
    \hline
    \textbf{Notes} & Allows to retrieve information about a store \\
...
\begin{tabularx}{\linewidth}{| g || p{10cm} |}
    ...
    \large{\textbf{Auth Controller}} & \cellcolor[HTML]{FFCC99} R.1, R.2, R.3, R.4, R7\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{User Controller}} & \cellcolor[HTML]{FFCC99} R.5, R.6, R.8, R.17 \\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    ...
    \hline
     \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Notification Manager}} & \cellcolor[HTML]{FFCC99} R.19, R.30\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Ticket Interface}} & \cellcolor[HTML]{FFCC99} R.9\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Ticker Controller}} & \cellcolor[HTML]{FFCC99} R.9, R.10, R.11, R.12\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    ...
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Visit Controller}} & \cellcolor[HTML]{FFCC99} R.13, R.15, R.20\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Storage Interface}} & \cellcolor[HTML]{FFCC99} R.1, R.4, R.5, R.6, R.8, R.9, R.10, \\
    & \cellcolor[HTML]{FFCC99} R.13, R.22, R.23, R.24, R.26, R.27, R.28, R.21\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    ...
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Store Controller}} & \cellcolor[HTML]{FFCC99} R.22, R.23, R.24, R.26, R.27\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Queue Manager}} & \cellcolor[HTML]{FFCC99} R.9, R.10, R.13, R.15, R.28, R.29\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Store Map Manager}} & \cellcolor[HTML]{FFCC99} R.15\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    ...
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Notification Service}} & \cellcolor[HTML]{FFCC99} R.19, R.30\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    ...
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Totem}} & \cellcolor[HTML]{FFCC99} R.29\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    ...
    \hline
    \rule{0pt}{15pt}&\cellcolor[HTML]{FFCC99} \\
    \large{\textbf{Stores Controller}} & \cellcolor[HTML]{FFCC99} R.9, R.13\\
    & \cellcolor[HTML]{FFCC99}\\
    \hline
...
1 & @ minor revisions      & 0.5 \\ \hline
\STcopy{v}{a2+1} & @ map algorithm     & 5 \\ \hline
...
\hline
 & @ \textbf{Description}                  & @ Hours \\\hline
1 & @ Introduction and Purpose      & 0.7 \\ \hline
2 & @ High level components overview     & 0.7 \\ \hline
3 & @ Component View     & 3 \\ \hline
4 & @ Queue Scaling Process     & 5 \\ \hline
5 & @ Description of the selected architectural patterns     &  2.5 \\ \hline
6 & @ User interfaces     & 1 \\ \hline
7 & @ User Experience Diagrams     & 0.6 \\ \hline
8 & @ First approach Functional Requirements     & 2.5 \\ \hline
9 & @ Finished Functional Requirements     & 1.8 \\ \hline
10 & @ Revision     & 0.5 \\ \hline
11 & @ Modified UX     & 0.4 \\ \hline
12 & @ More Revision     & 0.4 \\ \hline
13  & @ Start of Component View Diagram     & 1 \\ \hline
14 & @ Finish of Component View Diagram     & 1.5 \\ \hline
15 & @ Func requirements adjustments and other adjustments   & 1.2 \\ \hline
16 & @ Final call   & 3 \\ \hline
17 & @ Other calls   & 8 \\ \hline
...
\hline
 & @ \textbf{Description}                  & @ Hours \\\hline
1 & @ Document revision and deployment diagram     & 1 \\ \hline
2 & @ Deployment View, start Component Interface     & 3 \\ \hline
3 & @ Implementation, Integration and Test Plan and some revision & 7 \\ \hline
4 & @ System Integration diagram & 0.4  \\ \hline
5 & @ Review first chapter and some additions & 1.4 \\ \hline
6 & @ Revision of some chapters and edit of some diagrams & 2 \\ \hline
7 & @ Final call   & 2 \\ \hline
8 & @ Other calls   & 8 \\ \hline
